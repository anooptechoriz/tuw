...
// import 'package:tuw_services/screens/serviceman%20settings%20profile/serviceman_profile_edit.dart';
...
// class FavoriteServiceManDetails extends StatefulWidget {
//   Favorites? serviceman;
//   FavoriteServiceManDetails({super.key, this.serviceman});

//   @override
//   State<FavoriteServiceManDetails> createState() =>
//       _FavoriteServiceManDetailsState();
// }

// class _FavoriteServiceManDetailsState extends State<FavoriteServiceManDetails> {
...
//                 // ),
//                 Text(
//                     // '${widget.serviceman?.countryName ?? ''} | ${userData?.state ?? ''}',
//                     widget.serviceman?.homeLocation ?? '',
//                     style: getRegularStyle(
